...
setTimeout(async () => {
    ...
    this.allBinanceFutures = this.sortByPopularity(binanceFuturesList).slice(0, MAX_SYMBOLS);
    this.allBinanceSpot = this.sortByPopularity(binanceSpotList).slice(0, MAX_SYMBOLS);
    this.allBybitFutures = this.sortByPopularity(bybitFuturesList).slice(0, MAX_SYMBOLS);
    this.allBybitSpot = this.sortByPopularity(bybitSpotList).slice(0, MAX_SYMBOLS);
    
    this.binanceSymbolsCache = [...this.allBinanceFutures, ...this.allBinanceSpot];
    this.bybitSymbolsCache = [...this.allBybitFutures, ...this.allBybitSpot];
