...
__updateModelOnly(price) {
   ...
   _syncPriceLine(price) {
    ...
    series.update({
        ...
        open: lastCandle.open,    // open из kline
        high: lastCandle.high,    // high обновлён
        low: lastCandle.low,      // low обновлён
        close: price              // close из trade
    });
